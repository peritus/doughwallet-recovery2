(function() {
    ...
    var DOUGHWALLET_CONCEPTION_TIME = '2014-11-26T11:06:40:00Z';
    ...
    DOM.downloadPrivateKeys = $("button#downloadprivatekeys");
    ...
    function init() {
        ...
        DOM.downloadPrivateKeys.on("click", downloadPrivateKeys);
    ...
    function downloadPrivateKeys() {
        ...
        var header = '# KEEP YOUR PRIVATE KEYS SAFE !\n# Anyone who can read this file can spend your dogecoin.\n#\n# Format:\n#   <Base58 encoded private key>[<whitespace>[<key createdAt>]]\n#\n#   The Base58 encoded private keys are the same format as\n#   produced by the Satoshi client/ sipa dumpprivkey utility.\n#\n#   Key createdAt is in UTC format as specified by ISO 8601\n#   e.g: 2011-12-31T16:42:00Z . The century, \'T\' and \'Z\' are mandatory\n#\n#\n# Generated by doughwallet-recovery2.html on ' + (new Date()).toISOString() + '\n#\n#\n\n';

        var first_address = $($('td.address')[0]).text();

        var filename = 'doughwallet_recovery2_for_multidoge_' + first_address + '.keys';

        var privkeys = $('td.privkey').map(function (index, el) { return $(el).text()});

        var text = header + privkeys.toArray().join(' ' + DOUGHWALLET_CONCEPTION_TIME + '\n');
